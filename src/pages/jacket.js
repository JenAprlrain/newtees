...
import tee1 from '../images/jacketdisplay.png';
import tee2 from '../images/jacket.gif';
import tee3 from '../images/jacketnft.png';
...
function Jacket() {
    ...
    const shouldAutoplay = windowWidth > 768; // Autoplay on screens wider than 768px
        ...
        const handleButtonClick = () => {
            window.open('https://paintswap.finance/marketplace/fantom/44449', '_blank');
          };
...
return (
    <div>
      ...
      <button className="connect-button" onClick={handleButtonClick}>
              Visit NFT on Paintswap
      </button>
      </div>
      <div className="image-row2">
  <div className="image-item">
    <a href="https://paintswap.finance/marketplace/fantom/44449" target="_blank" rel="noopener noreferrer">
